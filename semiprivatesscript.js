const frenchContent = {
  title: "Séances d'entraînement semi-privées Judo & BJJ – Été",
  sectionTitle1: "Petit Groupe – Gros Progrès <br><em>Commence cet été!</em>",
  sectionContent1: "Cet été, maintenez votre enfant actif et en progression dans son parcours en arts martiaux avec nos <strong>séances semi-privées de Judo & Jiu-Jitsu Brésilien</strong> – conçues pour une attention personnalisée et une amélioration continue.<br><br>Limités à seulement <strong>6 étudiants par séance</strong>, ces cours en petits groupes permettent un encadrement individuel, un apprentissage plus approfondi et une connexion plus forte avec les partenaires d'entraînement.<br><br>Que votre enfant débute ou revienne pour consolider ce qu'il a appris, ces séances sont parfaites pour rester constant et motivé pendant les vacances d'été. Nos entraîneurs expérimentés se concentrent sur des techniques réelles, la qualité du mouvement et favorisent un environnement respectueux, stimulant et amusant.",
  sectionTitle2: "Pourquoi Semi-Privé?",
  sectionContent2: "✅ Maximum de 6 enfants par séance<br>✅ Instruction personnalisée et développement plus rapide des compétences<br>✅ Continuer l'entraînement pendant que d'autres font une pause<br>✅ Renforcer la discipline, la coordination et la confiance en soi<br><br><strong>Ne manquez pas cette occasion de garder votre enfant engagé, d'apprendre et de grandir pendant les mois d'été.</strong>",
...
const englishContent = {
  title: "Semi-Private Judo & BJJ – Summer Training Sessions",
  sectionTitle1: "Small Group – Big Progress <br><em>Starts This Summer!</em>",
  sectionContent1: "This summer, keep your child active and progressing in their martial arts journey with our <strong>Semi-Private Judo & Brazilian Jiu-Jitsu sessions</strong> – designed for personalized attention and steady improvement.<br><br>Limited to just <strong>6 students per session</strong>, these small group classes allow for more individual coaching, deeper learning, and a stronger connection with training partners.<br><br>Whether your child is just starting or returning to build on what they’ve learned, these sessions are perfect for staying consistent and motivated over the summer break. Our experienced coaches focus on real technique, movement quality, and fostering a respectful, challenging, and fun environment.",
  sectionTitle2: "Why Semi-Private?",
  sectionContent2: "✅ Max 6 kids per session<br>✅ Personalized instruction & faster skill development<br>✅ Continue training while others take a break<br>✅ Build discipline, coordination, and confidence<br><br><strong>Don't miss this opportunity to keep your child engaged, learning, and growing through the summer months.</strong>",
