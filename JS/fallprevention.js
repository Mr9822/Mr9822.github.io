document.addEventListener('DOMContentLoaded', function () {
    ...
    const sectionTitle4 = document.getElementById('section-title-4'); // Added for "Enroll Now!"
    ...
    languageSelection.addEventListener('change', function () {
      ...
      if (selectedLanguage === 'fr') {
        ...
        sectionTitle4.textContent = 'Inscrivez-vous dès maintenant !'; // Translated "Enroll Now!"
        sectionContent4.textContent = "Faites le premier pas vers un mode de vie plus sûr et plus actif!";
  
        disclaimerTitle.textContent = 'Avertissement'; // Translated "Disclaimer"
