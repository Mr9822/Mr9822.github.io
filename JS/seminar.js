document.addEventListener('DOMContentLoaded', function () {
    ...
    languageSelection.addEventListener('change', function () {
        ...
        if (selectedLanguage === 'fr') {
            ...
            aboutPhilanthropy.textContent = "Au-delà de ses impressionnantes références en arts martiaux, Hal est également reconnu pour son engagement philanthropique. Il a organisé de nombreux événements de collecte de fonds, y compris le remarquable défi 60x60@60, qui a permis de récolter 75 000 $ pour Little Warriors, une organisation nationale dédiée à la prévention et au traitement des abus sexuels sur les enfants. De plus, il est le co-créateur du séminaire Kids Helping Kids, une initiative en soutien à Little Warriors Canada.";
            ...
            detailsContent.innerHTML = `
                <ul class="event-details">
                    ...
                    <li><strong>Heure :</strong> 18h-20h</li>
            ...
            aboutPhilanthropy.textContent = "Beyond his impressive martial arts credentials, Hal is also renowned for his dedication to philanthropy. He has organized numerous fundraising events, including the remarkable 60x60@60 challenge, which raised $75,000 for Little Warriors, a national charity dedicated to the prevention and treatment of child sexual abuse. Additionally, he is the co-creator of the Kids Helping Kids Seminar, an initiative in support of Little Warriors Canada.";
