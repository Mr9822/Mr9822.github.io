const frenchContent = {
  ...
  guideList: [
    ...
    { id: "rear-mount-position", text: "Position de Montée du dos : 4 points" }, 
...
const englishContent = {
  ...
  guideList: [
    ...
    { id: "bottom-positions", text: "Bottom Positions: Have specific sweeps and escapes drilled into muscle memory." },
    { id: "submissions", text: "Submissions: Focus on a few high-percentage submissions that you can execute well." },
    { id: "defense", text: "Defense: Be prepared to defend against common attacks and recover from bad positions." },
    ...
    { id: "spar-with-partners", text: "Spar with Different Partners: This will expose you to various styles and body types." },
    { id: "drill-drill-drill", text: "Drill, Drill, Drill: Repetition builds proficiency. Focus on the techniques in your game plan." },
    { id: "conditioning", text: "Conditioning: Incorporate cardio, strength training, and flexibility exercises. Jump rope, running, and bodyweight exercises are excellent choices." },
    ...
    { id: "relax-and-breathe", text: "Relax and Breathe: Learn to control your breathing. Practice deep diaphragm breathing: inhale through your nose for four seconds, fill your lungs, and exhale through your mouth for eight seconds." },
    { id: "visualization", text: "Visualization: Picture your matches in your mind. See yourself executing your game plan, staying calm, and handling any challenges. Always visualize positive outcomes." },
    ...
    { id: "passing-guard", text: "Passing the Guard: 3 points" },
    { id: "mount-position", text: "Mount Position: 4 points" },
    { id: "rear-mount-position", text: "Rear Mount Position: 4 points" },
    { id: "gear-up", text: "6. Gear Up" },
    { id: "gear-up-text", text: "Ensure you have the correct gear." },
    { id: "gi", text: "Gi: Make sure your gi is IBJJF-legal or meets the specific tournament’s requirements. It should be clean and in good condition." },
    ...
    { id: "routine", text: "Routine: Perform a familiar warm-up routine that you do before training sessions." },
    { id: "focus", text: "Focus: Concentrate on your movements and breathing, not the upcoming matches." },
    ...
    { id: "hydrate", text: "Hydrate: Drink plenty of water leading up to the competition." },
    { id: "eat-smart", text: "Eat Smart: Consume a balanced diet rich in proteins, carbohydrates, and healthy fats. On the day of the competition, eat light, easily digestible foods." },
    ...
    { id: "review-performance", text: "Review Performance: Analyze what went well and what could be improved." },
